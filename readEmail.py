...
#https://codehandbook.org/how-to-read-email-from-gmail-api-using-python/
    ...
    print('social_affairs is ',type(category_classifier_func(category_classifier)[13]))
    ...
    scores_dict = {'Date':checkdate_list,'Content':str_to_return,'Introvert(I)': intro_extro_func(intro_extro)[0], 'Extrovert(E)':intro_extro_func(intro_extro)[1],
    ...
    result.to_csv('/var/www/html/data_score/gmail_'+ username +'_'+timestamp1+'_'+timestamp2+'.csv',index=False)
    print('You can now download the data at /var/www/html/data_score/gmail_'+ username +'_'+timestamp1+'_'+timestamp2+'.csv')

    filename_new='/var/www/html/data_score/gmail_'+ username +'_'+timestamp1+'_'+timestamp2+'.csv'
