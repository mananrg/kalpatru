...
from google_html_all import get_postscount_and_posts_visited_history
...
from test_findall_melbourne_aus import googlesearch2df,googlevisited2df
...
count,postconcat,checkdate_list,scores,intro_extro,judging_function,lifestyle,perceiving_function,type_indicator_analyzer,category_classifier=get_postscount_and_posts_visited_history(username)
...
#os.chdir('data_score/')
result.to_csv('/var/www/html/data_score/google_visited_history_all_australia_'+username + '.csv',index=False)
print('You can now download the data at /var/www/html/data_score/google_visited_history_all_australia_'+ username+'.csv')
